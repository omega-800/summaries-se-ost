...
#add-note(
  id: "1007",
  [DNS Record: NS],
  [ domain, hostname of authoritateive NS for this domain ],
)
#add-note(
  id: "1008",
  [DNS Record: MX],
  [ domain, name of mailserver ],
)
#add-note(id: "1009", [DNS Record: PTR], [ IP, domain ])

#add-note(
  id: "1010",
  [TCP Segment size],
  [IPv4: 1440-1480b, IPv6: <=1460b],
)
#add-note(
  id: "1011",
  [Multiplexing],
...
#add-note(id: "1043", [IPv6 Address: Loopback], [::1])
#add-note(
  id: "1044",
  [IPv6 Address: IPv4-Embedded],
  [64:ff9b::/96],
)
#add-note(
  id: "1045",
  [IPv6 Address: Discard-Only],
  [100::/64],
)
#add-note(
  id: "1046",
...
#add-note(
  id: "1050",
  [IPv6 Address: All nodes, within scope 2 (link-local).],
  [ff02::1],
)
#add-note(
  id: "1051",
  [IPv6 Address: All routers, within scope 2 (link-local).],
  [ff02::2],
)
#add-note(
  id: "1052",
  [IPv6 Address: Solicited multicast address group],
  [ff02::1:ffxx:xxxx],
)
#add-note(
  id: "1053",
