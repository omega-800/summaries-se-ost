...
#let content(cs) = [
  ...
  #exbox(title: $"ggT"(122,72), a=122, b=72$, [
    ...
    - Iteration: #table(
        ...
        table-header([], [$x = y_(-1)$], [$y = r_(-1)$], [$q=x "div" y$], [$r=x mod y = x - q dot y$]),
  ...
  #table(
    ...
    [1], [-6], [], [$"II''"$], g(0), [1],
    [2], [-4], [], [$"III''"$], g(0), g(0),
    [2], [-2], r($dot 1/2$), ct, [$"I'''"$], [1],
    [1], [1], [-6], r($-("III'''")$), [$"II'''"$], g(0),
    [1], [2], [-4], r($-2("III'''")$), [$"III'''"$], g(0),
    g(0), [1], [-1], [], ct,
  )
