...
// TODO:
// #add-note(id: "2009",  [Streng wachsende Funktion],[Monoton wachsende Funktion])
// #add-note(id: "2010",  [ $x < accent(x, ~) -> f(x) <= f(accent(x, ~))$ \ Bsp: $ f(x) = cases(x","&x<=1, 1","&1<x<=2, (x-2)^2+1", "&x>2) $ ],[Streng fallende Funktion])
// #add-note(id: "2011",  [ $x < accent(x, ~) -> f(x) > f(accent(x, ~))$ ],[Monoton fallende Funktion])
// #add-note(id: "2012",  [ $x < accent(x, ~) -> f(x) >= f(accent(x, ~))$ ],[Umkehrfunktion])
// #add-note(id: "2013",  [ $f(x) = y <=> f^(-1) (y) = x$ ],[Stetige Funktion])
// #add-note(id: "2014",  [Funktion, deren Graph keine Sprünge oder Unterbrechungen aufweist],[Stetig fortsetzbare Funktion])
...
#add-note(id: "2021", [Nullstellenform Quadratisch], [
  - $f(x) = a^2 x + b x + c$
  - $f(x) = a(x - x_0)(x - x_1)$
])
#add-note(id: "2023", [Nullstellenform Qubisch], [
...
#add-note(id: "2025", [ Verknüpfung von Funktionen], [
...
#add-note(id: "2026", [$a^(log_a (x))$], [$x$])
#add-note(
  id: "2027",

  [$log_a (1)$],
  [$0 "weil a hoch was ist 1"$],
)
#add-note(id: "2028", [$log_a (a)$], [$1$])
#add-note(
  id: "2029",
  [$log_a (x/y)$],
  [$log_a (x) - log_a (y)$],
...
#add-note(id: "2038", [Ungleichungen], [
...
// TODO:
// #add-note(id: "2040",    [x],[0])
// #add-note(id: "2041",  [$30=pi/6$],[$45 = pi/4$])
// #add-note(id: "2042",  [$60=pi/3$],[$90 = pi/2$])
// #add-note(id: "2043",    [$sin(x)$],[0])
// #add-note(id: "2044",  [0.5],[$sqrt(2)/2$])
// #add-note(id: "2045",  [$sqrt(3)/2$],[1])
// #add-note(id: "2046",    [$cos(x)$],[1])
// #add-note(id: "2047",  [$sqrt(3)/2$],[$sqrt(2)/2$])
// #add-note(id: "2048",  ([0.5],[0])

#add-note(id: "2049", $tan(x)$, $sin(x)/cos(x)$)
#add-note(
  id: "2050",
...
#add-note(
  id: "2081",
  [$(dif x)/(dif y) arcsin(x)$],
  [$1/sqrt(1-x^2)$],
)
#add-note(
  id: "2062",
  [$(dif x)/(dif y) arccos(x)$],
  [$- 1/sqrt(1-x^2)$],
)
#add-note(
  id: "2082",
  [$(dif x)/(dif y) arctan(x)$],
  [$1/(1+x^2)$],
)
...
#add-note(
  id: "2067",
  [Funktionen ableiten: Quotientenregel],
  [ $ (f/g)' = (f' g-f g')/g^2 $ ],
)
